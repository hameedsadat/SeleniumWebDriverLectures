...
public class HandleSSLcertificates {
	...
	public static void main(String[] args) throws InterruptedException {
		 ...
		 * we use classess like chromeoptions or firefoxoptions with class desirecapability to handle ssl certificate
		 * 
		 * Notice: it needs furthe work to be work successfully
		 * 
		 */
