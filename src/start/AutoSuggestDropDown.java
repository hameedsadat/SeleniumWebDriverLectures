...
public class AutoSuggestDropDown {
	...
	public static void main(String[] args) throws InterruptedException, WebDriverException {
		 ...
		 * wait.until(ExpectedConditions.elementToBeClickable(From)); From.click();
		 */
		/*
		 * WebElement From = driver.findElement(By.xpath("//span[text()='From']"));
		 * 
		 ...
		 * "//span[text()='From"))); From.click();
		 */
		//Actions action = new Actions(driver);
		//action.moveToElement(From);
		/*
		 * From.sendKeys("Seattle"); From.sendKeys(Keys.ARROW_DOWN);
		 ...
		 * ARROW_DOWN); driver.findElement(By.xpath("//span[text()='From']")).click();
		 */
		/*
		 * WebElement From = driver.findElement(By.xpath("//span[text()='From']"));
		 * WebElement From =
		 * driver.findElement(By.xpath("//span[text()='From']")).click(); //WebElement
		 * FromText = driver.findElement(By.xpath("//input[@placeholder='From']"));
		 */		
